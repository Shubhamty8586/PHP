...
$sql = "INSERT INTO `form` (`Name`, `Email`, `Gender`, `Number`, `Password`)
...
<body>
    ...
    <div class="container my-4">
        ...
        <form action="/cwhphp/40.form_1.php" method="post">
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control" id="Mobile" aria-describedby="mobileHelp">
            </div>
            <div class="mb-3">
