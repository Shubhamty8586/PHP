...
<html lang="en">
  <head>
    ...
    <title>Tutorail 6 On PHP Variables</title>
  </head>
  <body>
...
<div class="container my-3">
        ...
        <ul>
            ...
            <li>Must Starts with a letter or an underscore Character</li>
            <li>Can only contain Alphanumeric characters and underscores</li>
            <li>Variables in PHP are Case Sensitive. ($harry, $harry, $hArry are different)</li>
            <?php $name = "Harry"; echo $name; ?>
        </ul>
</div>
    <!-- Optional JavaScript -->
